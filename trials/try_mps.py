...
train_dataset = MNIST("./downloads", train=True, download=True, transform=ToTensor())
test_dataset = MNIST("./downloads", train=False, download=True, transform=ToTensor())
...
print(f"\nOptimization Finished! Total spend: {(time.time() - start_time)/60.0:0.2f}m")
